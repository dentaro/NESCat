...
#define USBHOST_STORAGE 0               // USB HOST Mass Storage features: 0=disabled, 1=enabled
#define USBHOST_HID 0                   // USB HOST HID features: 0=disabled, 1=enabled
#define USBHOST_JOYSTICKS 0             // USB HOST MULTIPLE JOYSTICK features: 0=disabled, 1=enabled
...
#define LCD_SPI_SPEED 64000000          // 1.54" ST7789 LCD can handle 80MHz SPI
...
#define GPIO_BUTTONS 4                  // 0=disabled, 1=IC 4017 Buttons, 2=Buttons Matrix, 3=direct pull, 4=dentaro device
#define CLOCK 1                         // View CLOCK on main screen
#define LCD_WIDTH 256                   // LCD MAX WIDTH
#define LCD_HEIGHT 256                  // LCD MAX HEIGHT
...
//--------------------------------------------------------------------------------
// DENTARO KEY BUTTONS PINS: (Direct Buttons Pulleddown & 3 Volume Buttons)
//--------------------------------------------------------------------------------
#if(GPIO_BUTTONS == 4)
//KEY BUTTONS PINS:
//#define PIN_UP     39  //SVN
#define PIN_DOWN   22  //IO35
//#define PIN_LEFT   36  //SVP
//#define PIN_RIGHT  12  //TDI => Do not install 330R resistor!!!
//#define PIN_A      2   //IO2
//#define PIN_B      14  //TMS
#define PIN_START  36  //TDO
#define PIN_SELECT 25  //TCK
#endif
...
#define LCD_BACKLIGHT_PIN 32 //IS HARDWARE PULLED UP
#endif
#ifdef NCAT_TWATCH_V1
...
#define PWMAUDIO_CONFIG_LEFT_CHANNEL_GPIO 26
#define PWMAUDIO_CONFIG_RIGHT_CHANNEL_GPIO -1
#endif
#endif
//--------------------------------------------------------------------------------
...
//        cfg.pin_dc = 27;
        ...
        cfg.spi_mode = 0;
        cfg.freq_write = LCD_SPI_SPEED; // (80MHz) 1.54" ST7789
        cfg.freq_read = 16000000;//40000000;
        cfg.spi_3wire = true;//false;
        cfg.use_lock = true;//false;
        cfg.dma_channel = 0;//1;
        cfg.pin_sclk = 14;
        cfg.pin_mosi = 13;
        cfg.pin_miso = 12;//-1;
...
//#define SD_CONFIG SdSpiConfig(SD_CS_PIN, DEDICATED_SPI, SD_SCK_MHZ(25)) //20MHz recommending 25MHz MAX.
  ...
  #define SD_CONFIG SdSpiConfig(SD_CS_PIN, SHARED_SPI, SD_SCK_HZ(10000000)) //20MHz recommending 25MHz MAX. SHARED VSPI (used also for USB Host)　10000000じゃないと動かない
#endif
#if defined(NCAT_VGA)
...
//    tft.setCursor( 0, 0 );
//    
//    //tft.println(phbs.getValue());
//    
//    
//    tft.println(adc1_get_raw(ADC1_CHANNEL_7));
//    tft.println(adc1_get_raw(ADC1_CHANNEL_6));
//    tft.println(adc1_get_raw(ADC1_CHANNEL_3));
//    
//    tft.println(getPhVolVec(0, 1));
//    tft.println(getPhVolDir(2));
