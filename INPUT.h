...
#include "src/PhysicBtn/PhysicBtn.hpp"
PhysicBtn phbs;
...
//    if(predirectionBits==directionBits)//２回連続した時だけ前菜の値を出力
//    {
...
updatePhVols();//volボタン関連

if(getPhVolVec(0, 1)==7){INPUT_LEFT=1;}
if(getPhVolVec(0, 1)==1){INPUT_DOWN=1;}
if(getPhVolVec(0, 1)==3){INPUT_RIGHT=1;}
if(getPhVolVec(0, 1)==5){INPUT_UP=1;}

if(getPhVolDir(2)==7){INPUT_X =1;}
if(getPhVolDir(2)==1){INPUT_B =1;}
if(getPhVolDir(2)==3){INPUT_A =1;}
if(getPhVolDir(2)==5){INPUT_Y =1;}


updatePhBtns();//物理ボタン3つ
...
if(phbs.getValue() == 101||phbs.getValue() == 111){INPUT_START =1;}
if(phbs.getValue() == 102||phbs.getValue() == 112){INPUT_SELECT =1;}
if(phbs.getValue() == 103||phbs.getValue() == 113){INPUT_SYSTEM =1;}
